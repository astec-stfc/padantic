...
sys.path.append(r'C:\Users\jkj62.CLRC\Documents\GitHub\CATAP\Nightly\CATAP_Nightly_15_04_2024\python310')
...
class Test():
    ...
    def __init__(self):
        ...
        self.HardwareFactory = self.HFHF(self.CATAP_state, os.path.abspath('./to_CATAP/MasterLattice'))
