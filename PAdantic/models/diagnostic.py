...
class BPM_Diagnostic(DiagnosticElement):
    ...
    attenuation1_calibration: Union[NonNegativeInt, None] = Field(
        alias="att1cal", default=12
    )
    attenuation2_calibration: Union[NonNegativeInt, None] = Field(
        alias="att2cal", default=12
    )
