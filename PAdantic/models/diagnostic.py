...
class BPM_Diagnostic(DiagnosticElement):
    ...
    attenuation1_calibration: Union[NonNegativeInt, None] = Field(alias='att1cal', default=12)
    attenuation2_calibration: Union[NonNegativeInt, None] = Field(alias='att2cal', default=12)
    voltage1_calibration: Union[NonNegativeInt, None] = Field(alias='v1cal', default=1)
    voltage2_calibration: Union[NonNegativeInt, None] = Field(alias='v2cal', default=1)
    charge_calibration: Union[NonNegativeInt, None] = Field(alias='qcal', default=70)
    mn: Union[float, None] = 15
    xn: Union[float, None] = 0
    yn: Union[float, None] = 0
...
class Camera_Sensor(IgnoreExtra):
    ...
    bit_depth: int = 16
    operating_middle:  List[Union[float,int]] = [1000,1000] # OPERATING_CENTER_X, OPERATING_CENTER_Y
    mechanical_middle:  List[Union[float,int]] = [1000,1000] # MECHANICAL_CENTER_X, MECHANICAL_CENTER_Y
