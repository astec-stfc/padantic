...
catap_files = glob.glob('\\\\claraserv3.dl.ac.uk\\claranet\\packages\\CATAP\\Nightly\\CATAP_Nightly_17_01_2024\\python310\\MasterLattice\\*\\CLA*.yaml', recursive=True)
catap_files += glob.glob('\\\\claraserv3.dl.ac.uk\\claranet\\packages\\CATAP\\Nightly\\CATAP_Nightly_17_01_2024\\python310\\MasterLattice\\*\\CLA*.yml', recursive=True)
