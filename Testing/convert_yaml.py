...
with open(r'C:\Users\jkj62.CLRC\Documents\GitHub\SimFrame_Examples\FEBE\StandardSetups\Setups\Setup_1_250pC\lattice.yaml', 'r') as stream:
    try:
...
sdds_twiss = {}
sdds_twiss_file = sddsread(r'C:\Users\jkj62.CLRC\Documents\GitHub\SimFrame_Examples\FEBE\StandardSetups\Setups\Setup_1_250pC\FEBE.twi')
...
for name, elem in lattice['elements'].items():
    if elem['type'] == 'quadrupole' and '-FEA-' not in name and '-FEH-' not in name and '-FED-' not in name:
