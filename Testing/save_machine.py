...
machine = PAdantic(layout_file='../PAdantic/Machines/CLARA/layouts.yaml', section_file='../PAdantic/Machines/CLARA/sections.yaml', yaml_dir='../PAdantic/Machines/CLARA/YAML')
